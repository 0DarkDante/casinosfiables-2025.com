...
<html lang="fr">
  ...
  <p>
    ...
    Lorsqu’un utilisateur publie un commentaire sur CasinosComparesFR, nous recueillons les informations renseignées dans le formulaire, ainsi que l’adresse IP et les détails du navigateur. Ces données sont utilisées pour prévenir le spam et les abus.
  </p>

  <p>
    Un identifiant anonyme de votre adresse e-mail peut être transmis à Gravatar afin de vérifier si vous utilisez ce service.
  </p>

  <p>
    <strong>Téléchargement d’images</strong><br />
    Nous déconseillons de publier des images contenant des métadonnées de localisation (EXIF GPS), car ces informations peuvent être accessibles par d’autres utilisateurs.
  </p>

  <p>
    <strong>Cookies</strong><br />
    Si vous laissez un commentaire, vous pouvez choisir de sauvegarder votre nom, votre e-mail et votre site dans des cookies. Cela facilite vos interactions ultérieures en évitant de ressaisir ces informations. Ces cookies restent actifs pendant une durée maximale d’un an.
  </p>

  <p>
    <strong>Contenus externes intégrés</strong><br />
    Certains éléments du site, comme des vidéos ou images, proviennent de sites tiers. Leur affichage équivaut à une visite sur ces plateformes, qui peuvent alors collecter des données, utiliser des cookies et suivre votre navigation.
  </p>

  <p>
    <strong>Stockage et gestion des données</strong><br />
    En cas de demande de réinitialisation de mot de passe, votre adresse IP peut être incluse dans l’e-mail envoyé.
  </p>

  <p>
    Les commentaires ainsi que leurs métadonnées sont conservés indéfiniment pour faciliter la modération et accélérer l’approbation des contributions futures.
  </p>

  <p>
    Les données fournies lors de l’inscription sont hébergées sur des serveurs sécurisés bénéficiant de mesures de protection appropriées.
  </p>

  <p>
    <strong>Vos droits</strong><br />
    Vous pouvez demander une copie complète des données personnelles que nous détenons à votre sujet et également solliciter leur suppression, sauf si des obligations légales ou des raisons de sécurité empêchent cette suppression temporairement.
  </p>
</main>
